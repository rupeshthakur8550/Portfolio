...
import Food_Space from '../Assets/FoodSpace.png'
    ...
    return (
        ...
        >
            <div className={`w-full p-8 rounded-lg shadow-lg ${theme === 'light' ? 'bg-white' : 'bg-gray-800'}`}>
                <h1 className={`text-4xl my-12 text-center font-bold border-x-4 ${theme === 'light' ? 'text-orange-700 border-gray-900' : 'text-orange-200'}`}>
                    PROJECTS
                </h1>
